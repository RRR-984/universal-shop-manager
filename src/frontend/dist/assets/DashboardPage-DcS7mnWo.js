import { m as createLucideIcon, n as commonjsGlobal, o as getDefaultExportFromCjs, r as reactExports, p as clsx, R as React2, q as invariant, b as useNavigate, c as useApi, d as useStore, A as AnalyticsPeriod, t as t$1, j as jsxRuntimeExports, B as Badge, P as Package, v as ChevronDown, w as Receipt, f as Button, x as ShoppingCart, y as Plus } from "./index-CNXs12t8.js";
import { S as Skeleton } from "./skeleton-DRrrEpkc.js";
import { u as ue } from "./index-CkUuusRi.js";
import { b as buildReminderWhatsAppText } from "./BillShareCard-DPAauvtl.js";
import { f as formatCurrency } from "./currency-KTzMGZJt.js";
import { f as formatDate } from "./date-DnqYKOdL.js";
import { S as Store } from "./store-B6UzXi2B.js";
import { B as Bell } from "./bell-CYaXYvBS.js";
import { C as CircleCheck } from "./circle-check-B-JqpOTd.js";
import { M as MessageCircle } from "./message-circle-aI4f5Jxn.js";
import { C as CircleAlert } from "./circle-alert-BnIukzqe.js";
import { T as TrendingUp } from "./trending-up-qYGZtntI.js";
import { F as FileText } from "./file-text-0DQE1Pes.js";
import { I as Info } from "./info-DzjxVLj1.js";
import "./printer-4IqMGJRH.js";
import "./dialog-D-n2xHWK.js";
import "./input-DeXUznaN.js";
import "./label-DPOtEUDX.js";
/**
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-muted-foreground leading-tight", children: label }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          sublabel && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: sublabel })
        ] }),
        tooltip && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-12 group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "w-3.5 h-3.5 text-muted-foreground cursor-help" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-10 bottom-full right-0 mb-1 w-48 px-2.5 py-1.5 bg-foreground text-background text-xs rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity", children: tooltip })
        ] })
      ]
    }
  );
...
function PeriodToggle({ period, onChange }) {
  const options = [
    { value: AnalyticsPeriod.Today, label: t$1("today") },
    { value: AnalyticsPeriod.Week, label: t$1("thisWeek") },
    { value: AnalyticsPeriod.Month, label: t$1("thisMonth") }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 bg-muted p-1 rounded-lg w-fit", children: options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      "data-ocid": `dashboard.period.${opt.value.toLowerCase()}`,
      onClick: () => onChange(opt.value),
      className: `px-3 py-1.5 text-sm font-medium rounded-md transition-all duration-150 ${period === opt.value ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
      children: opt.label
    },
    opt.value
  )) });
...
function MetricSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-4 md:p-5 flex flex-col gap-3", children: [
...
function ChartTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg shadow-lg px-3 py-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground mb-1 truncate max-w-[140px]", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-primary", children: formatCurrency(payload[0].value, currency) })
  ] });
}
function expiryUrgencyClass(daysLeft) {
  if (daysLeft <= 7) return "text-red-600";
  if (daysLeft <= 30) return "text-orange-600";
  if (daysLeft <= 90) return "text-yellow-600";
  return "text-muted-foreground";
}
function expiryBorderClass(daysLeft) {
...
function DashboardPage() {
  ...
  const shopConfig = useStore((s2) => s2.shopConfig);
  const shops = useStore((s2) => s2.shops);
  const selectedShopIds = useStore((s2) => s2.selectedShopIds);
  const userRole = useStore((s2) => s2.userRole);
  const isOwner = userRole !== "staff";
  const [period, setPeriod] = reactExports.useState(AnalyticsPeriod.Today);
  const [summary, setSummary] = reactExports.useState(null);
  const [topProducts, setTopProducts] = reactExports.useState([]);
  const [lowStock, setLowStock] = reactExports.useState([]);
  const [nearExpiry, setNearExpiry] = reactExports.useState([]);
  const [deadStock, setDeadStock] = reactExports.useState([]);
  const [pendingBills, setPendingBills] = reactExports.useState([]);
  const [pendingLoading, setPendingLoading] = reactExports.useState(false);
  const [loading, setLoading] = reactExports.useState(true);
  const [stockValue, setStockValue] = reactExports.useState(0);
  const [stockValueLoading, setStockValueLoading] = reactExports.useState(true);
  const [fastMoving, setFastMoving] = reactExports.useState([]);
  const [slowMoving, setSlowMoving] = reactExports.useState([]);
  const [movingLoading, setMovingLoading] = reactExports.useState(true);
  const [alertsLoading, setAlertsLoading] = reactExports.useState(true);
  const [activeAlertTab, setActiveAlertTab] = reactExports.useState("expiry");
  const [alertsPanelCollapsed, setAlertsPanelCollapsed] = reactExports.useState(false);
  const currency = (shopConfig == null ? void 0 : shopConfig.currency) ?? "USD";
  const shopName = (shopConfig == null ? void 0 : shopConfig.shopName) ?? "Your Shop";
  const dateFormat = shopConfig == null ? void 0 : shopConfig.dateFormat;
  ...
  const deadStockAlertDays = BigInt(
    (shopConfig == null ? void 0 : shopConfig.deadStockAlertDays) ?? BigInt(180)
  );
  const multiShopCount = selectedShopIds.length;
  const activeShopId = useStore((s2) => s2.activeShopId);
  const shopId = (() => {
    var _a;
    if (activeShopId) return activeShopId;
    const keys2 = ["activeShopId", "currentShopId", "shopId", "selectedShopId"];
    for (const k2 of keys2) {
      const v2 = localStorage.getItem(k2);
      if (v2 == null ? void 0 : v2.trim()) return v2.trim();
    }
  ...
  reactExports.useEffect(() => {
    ...
    getStockValue(shopId).then((v2) => {
      if (!cancelled) setStockValue(v2);
    }).catch(() => {
    }).finally(() => {
  ...
  reactExports.useEffect(() => {
    ...
    const nearExpiryCall = getNearExpiryProductsByDays ? getNearExpiryProductsByDays(shopId, BigInt(expiryThresholdDays)) : getNearExpiryProducts(shopId);
    Promise.all([
      ...
      setLowStock(ls);
      setNearExpiry(
        ne.sort((a2, b2) => Number(a2.daysLeft) - Number(b2.daysLeft))
      );
      setDeadStock(
        ds.sort((a2, b2) => Number(b2.daysInactive) - Number(a2.daysInactive))
      );
    }).finally(() => {
      if (!cancelled) setAlertsLoading(false);
      clearTimeout(timeout);
  ...
  const fetchPendingBills = reactExports.useCallback(async () => {
    ...
    try {
      ...
      ue.error("Failed to load pending bills");
    } finally {
  ...
  const periodLabel = {
    [AnalyticsPeriod.Today]: t$1("today"),
    [AnalyticsPeriod.Week]: t$1("thisWeek"),
    [AnalyticsPeriod.Month]: t$1("thisMonth")
  }[period];
  const todayStr = formatDate(/* @__PURE__ */ new Date(), dateFormat);
  const profitMarginPct = summary && summary.totalSales > 0 ? (summary.totalProfit / summary.totalSales * 100).toFixed(1) : "0.0";
  const chartData = topProducts.slice(0, 10).map((p2) => ({
    name: p2.name.length > 14 ? `${p2.name.slice(0, 12)}…` : p2.name,
    fullName: p2.name,
    revenue: p2.revenue,
    profit: p2.profit,
    qty: p2.totalQty
  }));
  const totalAlertCount = lowStock.length + nearExpiry.length + deadStock.length + pendingBills.length;
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        multiShopCount > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Store, { className: "w-4 h-4 text-primary" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground text-xs hidden sm:inline", children: [
                "Showing data for:",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: shops.filter((s2) => selectedShopIds.includes(s2.id)).map((s2) => s2.shopName).join(", ") })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Badge,
                {
                  ...
                  children: [
                    "Active: ",
                    shopConfig == null ? void 0 : shopConfig.shopName
                  ]
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-xl md:text-2xl font-bold text-foreground leading-tight", children: [
                "Welcome back, ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: todayStr })
            ] }),
            totalAlertCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PeriodToggle, { period, onChange: setPeriod }) })
        ] }),
        alertsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              [1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full mb-2 rounded-lg" }, i))
            ]
          }
        ) : totalAlertCount === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-2.5 bg-muted/40 border-b border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-4 h-4 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm text-foreground", children: "Stock Summary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-auto text-[10px] bg-green-100 text-green-700 border border-green-200 hover:bg-green-100", children: "All Clear" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y divide-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-2.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-3.5 h-3.5 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Products tracked" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: topProducts.length > 0 ? `${topProducts.length}+ products in stock` : "Inventory up to date" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-2.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-green-50 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5 text-green-600" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Expiry alerts" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-green-700", children: "No items expiring soon" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-2.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-green-50 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5 text-green-600" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Dead stock" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-green-700", children: "No slow-moving items" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-2.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-green-700", children: "Stock levels healthy" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" })
                ] })
              ] })
          ...
          "div",
          {
            ...
            className: `bg-card rounded-xl border-2 overflow-hidden transition-all ${nearExpiry.length > 0 ? "border-orange-200" : lowStock.length > 0 ? "border-red-200" : "border-muted"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `px-4 py-3 border-b flex items-center gap-2 ${nearExpiry.length > 0 ? "bg-orange-50 border-orange-200" : lowStock.length > 0 ? "bg-red-50 border-red-200" : "bg-muted/40 border-border"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Bell,
                      {
                        className: `w-4 h-4 flex-shrink-0 ${nearExpiry.length > 0 ? "text-orange-600" : lowStock.length > 0 ? "text-red-600" : "text-muted-foreground"}`
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h2",
                      {
                        className: `font-display font-semibold text-sm flex-1 ${nearExpiry.length > 0 ? "text-orange-700" : lowStock.length > 0 ? "text-red-700" : "text-foreground"}`,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Badge,
                      {
                        className: `text-xs ${nearExpiry.length > 0 ? "bg-orange-100 text-orange-700 border-orange-200 hover:bg-orange-100" : lowStock.length > 0 ? "bg-red-100 text-red-700 border-red-200 hover:bg-red-100" : "bg-muted text-muted-foreground"}`,
                        children: [
                          totalAlertCount,
                          " total"
                        ]
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        onClick: () => setAlertsPanelCollapsed((v2) => !v2),
                        className: "ml-1 text-muted-foreground hover:text-foreground transition-colors",
                        "aria-label": alertsPanelCollapsed ? "Expand alerts" : "Collapse alerts",
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          ChevronDown,
                          {
                            className: `w-4 h-4 transition-transform duration-200 ${alertsPanelCollapsed ? "rotate-180" : ""}`
                          }
                        )
                      }
                    )
              ...
              !alertsPanelCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b border-border bg-muted/20", children: [
                  {
                    id: "pending",
                    label: "Pending",
                  ...
                  "button",
                  {
                    ...
                    className: `flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 text-xs font-medium border-b-2 transition-colors ${activeAlertTab === tab.id ? tab.urgent && tab.count > 0 ? "border-red-500 text-red-600 bg-red-50" : "border-primary text-primary bg-primary/5" : "border-transparent text-muted-foreground hover:text-foreground hover:bg-muted/40"}`,
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: `inline-flex items-center justify-center w-4 h-4 rounded-full text-[10px] font-bold ${tab.count > 0 ? activeAlertTab === tab.id ? tab.urgent ? "bg-red-500 text-white" : "bg-primary text-primary-foreground" : tab.urgent ? "bg-red-100 text-red-600" : "bg-muted-foreground/20 text-muted-foreground" : "bg-muted text-muted-foreground/40"}`,
                          children: tab.count
                        }
                      )
                    ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y divide-border max-h-72 overflow-y-auto", children: [
                  activeAlertTab === "pending" && (pendingLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4 text-sm text-muted-foreground", children: "Loading pending payments…" }) : pendingBills.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-amber-100 rounded-lg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "w-4 h-4 text-amber-600" }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-medium text-foreground text-sm truncate", children: [
                                bill.customerName || "Walk-in",
                                " ",
                                bill.customerPhone && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground font-normal", children: [
                                  "· ",
                                  bill.customerPhone
                                ] })
                              ] }),
                              ...
                              lastReminderDays !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-600", children: [
                                "Last reminder:",
                                " ",
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right flex-shrink-0", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-red-600", children: formatCurrency(bill.amountPending, currency) }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "pending" })
                            ] })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pl-11", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              Button,
                              {
                                type: "button",
                  ...
                  activeAlertTab === "expiry" && (nearExpiry.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-4 text-sm text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "✅" }),
                    " No expiring products within threshold"
                  ] }) : nearExpiry.map((p2, i) => {
                    const daysLeft = Number(p2.daysLeft);
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground text-sm truncate", children: p2.name }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                              "Expires:",
                              " ",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: p2.expiryDate })
                            ] })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              children: daysLeft <= 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-600", children: "Expired" }) : `${daysLeft}d left`
                            }
                          )
                        ]
                      },
                  ...
                  activeAlertTab === "lowstock" && (lowStock.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-4 text-sm text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "✅" }),
                    " All products are well-stocked"
                  ] }) : lowStock.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      "data-ocid": `dashboard.alerts.low_stock.item.${i + 1}`,
                      className: "flex items-center gap-3 px-4 py-3",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-4 h-4 text-red-600" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground text-sm truncate", children: p2.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                            "Min:",
                            " ",
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: p2.minStock })
                          ] })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-red-600", children: p2.stock }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "in stock" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Button,
                            {
                  ...
                  activeAlertTab === "dead" && (deadStock.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-4 text-sm text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "✅" }),
                    " No dead stock detected"
                  ] }) : deadStock.map((p2, i) => {
                    const days = Number(p2.daysInactive);
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${isVeryOld ? "bg-red-100" : "bg-muted"}`,
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                TrendingDown,
                                {
                                  className: `w-4 h-4 ${isVeryOld ? "text-red-500" : "text-muted-foreground"}`
                                }
                              )
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground text-sm truncate", children: p2.name }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: p2.lastSaleTime ? `Last sold ${days}d ago` : "Never sold" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Badge,
                            {
                              className: `text-xs flex-shrink-0 ${isVeryOld ? "bg-red-100 text-red-700 border-red-200 hover:bg-red-100" : "bg-muted text-muted-foreground border-border hover:bg-muted"}`,
                              children: days > 365 ? `${Math.round(days / 365)}yr+` : `${Math.round(days / 30)}mo`
                            }
                          )
                        ]
                      },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `px-4 py-2.5 border-t flex justify-end ${nearExpiry.length > 0 ? "bg-orange-50 border-orange-200" : lowStock.length > 0 ? "bg-red-50 border-red-200" : "bg-muted/20 border-border"}`,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MetricSkeleton, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx(MetricSkeleton, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx(MetricSkeleton, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx(MetricSkeleton, {})
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                MetricCard,
                {
                  ...
                  label: t$1("totalSales"),
                  value: summary ? formatCurrency(summary.totalSales, currency) : formatCurrency(0, currency),
              ...
              isOwner ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                MetricCard,
                {
                  ...
                  label: t$1("totalProfit"),
                  value: summary ? formatCurrency(summary.totalProfit, currency) : formatCurrency(0, currency),
                  sublabel: `${profitMarginPct}% margin`,
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-4.5 h-4.5" }),
                  accent: summary && summary.totalProfit < 0 ? "neutral" : "green",
                ...
                MetricCard,
                {
                  ...
                  sublabel: periodLabel,
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "w-4.5 h-4.5" }),
                  accent: "neutral"
                }
              ),
              isOwner ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                MetricCard,
                {
                  ...
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-4.5 h-4.5" }),
                  accent: "neutral"
                }
              )
            ] })
        ...
        isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-3", children: stockValueLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(MetricSkeleton, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          MetricCard,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-4.5 h-4.5" }),
            accent: "purple",
        ...
        !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-amber-100 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "w-5 h-5 text-amber-600" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-amber-600 uppercase tracking-wide mb-0.5", children: "Best Selling Product" }),
                topProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No sales yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-base truncate", children: topProducts[0].name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mt-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: topProducts[0].totalQty % 1 === 0 ? topProducts[0].totalQty.toFixed(0) : topProducts[0].totalQty.toFixed(2) }),
                      " ",
                      "units sold"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                      "Revenue:",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary", children: formatCurrency(topProducts[0].revenue, currency) })
                    ] }),
                    isOwner && topProducts[0].revenue > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                      "Margin:",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-profit", children: [
                        (topProducts[0].profit / topProducts[0].revenue * 100).toFixed(1),
                        "%"
                      ] })
                    ] })
                  ] })
        ...
        !movingLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-3 bg-muted/30 border-b border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-4 h-4 text-emerald-600 flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground flex-1", children: "Fast Moving" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-[10px] bg-emerald-100 text-emerald-700 border border-emerald-200 hover:bg-emerald-100", children: "Top 5" })
                ] }),
                fastMoving.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: fastMoving.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    "data-ocid": `dashboard.fast_moving.item.${i + 1}`,
                    className: "flex items-center gap-3 px-4 py-2.5",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-emerald-100 text-emerald-700 text-[10px] font-bold flex items-center justify-center flex-shrink-0", children: i + 1 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm font-medium text-foreground truncate", children: p2.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 justify-end", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-3 h-3 text-emerald-500" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-emerald-600", children: [
                          p2.totalQty % 1 === 0 ? p2.totalQty.toFixed(0) : p2.totalQty.toFixed(1),
                          " ",
                          "sold"
                        ] })
                      ] }) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-3 bg-muted/30 border-b border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-4 h-4 text-orange-500 flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground flex-1", children: "Slow Moving" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-[10px] bg-orange-100 text-orange-700 border border-orange-200 hover:bg-orange-100", children: "Watch list" })
                ] }),
                slowMoving.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    "data-ocid": "dashboard.slow_moving.empty_state",
                    className: "px-4 py-5 text-sm text-emerald-600 font-medium text-center",
                    children: "All products selling well!"
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: slowMoving.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    "data-ocid": `dashboard.slow_moving.item.${i + 1}`,
                    className: "flex items-center gap-3 px-4 py-2.5",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-orange-100 text-orange-700 text-[10px] font-bold flex items-center justify-center flex-shrink-0", children: i + 1 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm font-medium text-foreground truncate", children: p2.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 justify-end", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-3 h-3 text-orange-400" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-orange-600", children: [
                          p2.totalQty % 1 === 0 ? p2.totalQty.toFixed(0) : p2.totalQty.toFixed(1),
                          " ",
                          "sold"
                        ] })
        ...
        !loading && summary && summary.billCount === 0n && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-primary/10 rounded-2xl flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-7 h-7 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-semibold text-foreground text-lg", children: [
                "No sales yet for ",
                periodLabel
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1 max-w-xs", children: "Create your first bill to start tracking sales and profit in real time." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  type: "button",
        ...
        !loading && topProducts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": "dashboard.top_products.section",
            className: "bg-card rounded-xl border border-border overflow-hidden",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4 border-b border-border flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-base", children: t$1("topProducts") }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 pt-4 pb-2", style: { height: 220 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                BarChart,
                {
                  data: chartData,
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      YAxis,
                      {
                        tickFormatter: (v2) => formatCurrency(v2, currency),
                        tick: { fontSize: 10, fill: "hsl(var(--muted-foreground))" },
                        axisLine: false,
                        tickLine: false,
                        width: 60
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Tooltip,
                      {
                        content: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartTooltip, { currency }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-xs font-medium text-muted-foreground py-2 pr-3 w-8", children: "#" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-xs font-medium text-muted-foreground py-2 pr-3", children: t$1("productName") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right text-xs font-medium text-muted-foreground py-2 pr-3", children: t$1("qty") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right text-xs font-medium text-muted-foreground py-2 pr-3", children: "Revenue" }),
                  isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right text-xs font-medium text-muted-foreground py-2", children: t$1("profit") })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: topProducts.slice(0, 10).map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "tr",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: `inline-flex items-center justify-center w-5 h-5 rounded-full text-xs font-bold ${i === 0 ? "bg-amber-100 text-amber-700" : i === 1 ? "bg-muted text-muted-foreground" : i === 2 ? "bg-orange-100 text-orange-700" : "bg-muted text-muted-foreground"}`,
                          children: i + 1
                        }
                      ) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-3 font-medium text-foreground truncate max-w-[120px] md:max-w-none", children: p2.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-3 text-right text-muted-foreground tabular-nums", children: p2.totalQty % 1 === 0 ? p2.totalQty.toFixed(0) : p2.totalQty.toFixed(2) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-3 text-right font-semibold text-primary tabular-nums", children: formatCurrency(p2.revenue, currency) }),
                      isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 text-right font-semibold text-profit tabular-nums", children: formatCurrency(p2.profit, currency) })
                    ]
                  },
                  String(p2.productId)
                )) })
