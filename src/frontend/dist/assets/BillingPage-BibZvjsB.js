import { m as createLucideIcon, T as TaxSystem, W as useTranslation, d as useStore, c as useApi, D as DateFormat, N as NumberFormat, r as reactExports, Q as PriceType, j as jsxRuntimeExports, U as Link, f as Button, y as Plus, X, V as PaymentType, H as Trash2, B as Badge } from "./index-CNXs12t8.js";
import { I as Input } from "./input-DeXUznaN.js";
import { u as ue } from "./index-CkUuusRi.js";
import { B as BillShareCard, a as BillPrintDialog } from "./BillShareCard-DPAauvtl.js";
import { f as formatCurrency, g as getCurrencyConfig } from "./currency-KTzMGZJt.js";
import { a as formatDateTime } from "./date-DnqYKOdL.js";
import { R as RotateCcw } from "./rotate-ccw-La8wxNyv.js";
import { S as Save } from "./save-DAH5D5pw.js";
import { P as Printer } from "./printer-4IqMGJRH.js";
...
import "./message-circle-aI4f5Jxn.js";
/**
...
function BillingPage() {
  ...
  const shopIdRef = reactExports.useRef(null);
        ...
        try {
          ...
          if (finalResults.length === 0) {
            try {
              ...
              ue.error("Product search failed. Please try again.");
            }
          }
          if (finalResults.length === 0) {
            try {
              ...
              finalResults = all.filter(
                (p) => p.isActive && (p.name.toLowerCase().includes(lower) || p.barcode && String(p.barcode).toLowerCase().includes(lower))
              );
            } catch (_) {
              ue.error("Product search failed. Please try again.");
            }
  ...
  const handleSave = async (andPrint = false) => {
    ...
    try {
      ...
      if (!andPrint) {
        setTimeout(() => {
          var _a;
          (_a = document.getElementById("bill-share-section")) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth", block: "nearest" });
        }, 200);
      }
      ...
      children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Bulk Sell" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col lg:flex-row min-h-0 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-4 lg:border-r", children: [
            ...
            ((shopConfig == null ? void 0 : shopConfig.taxRate) ?? 0) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              TaxSection,
              {
                taxSystem,
                taxRate,
        ...
        savedBill && !showPrint && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-md mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                BillShareCard,
                {
                  bill: {
                    ...
                    customerPhone: savedBill.customerPhone || (shopConfig == null ? void 0 : shopConfig.shopPhone) || ""
                  },
                  shopConfig
                }
              ) }),
