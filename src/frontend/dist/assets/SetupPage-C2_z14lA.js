import { u as useSearch, r as reactExports, a as useInternetIdentity, b as useNavigate, c as useApi, d as useStore, L as Language, N as NumberFormat, D as DateFormat, T as TaxSystem, S as ShopType, i as isRTL, j as jsxRuntimeExports, B as Badge, t, C as Check, e as cn, f as Button, g as ChevronLeft, h as ChevronRight, k as LoaderCircle, l as applyRTL, s as setLanguage } from "./index-T7Sl8NUk.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-card border-b border-border px-4 py-3 flex items-center gap-3 shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-base font-bold text-foreground leading-tight", children: isAddMode ? "Add New Shop" : "Universal Shop System" }),
