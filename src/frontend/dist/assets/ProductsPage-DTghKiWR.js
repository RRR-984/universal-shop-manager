import { m as createLucideIcon, r as reactExports, j as jsxRuntimeExports, y as useComposedRefs, z as composeRefs, e as cn, c as useApi, E as RestaurantCategory, b as useNavigate, d as useStore, S as ShopType, f as Button, F as ClipboardList, x as Plus, X, v as ChevronDown, P as Package, B as Badge, G as Trash2, M as Metal, H as RestaurantCategory$1, I as StationerySubType, J as SizeSystem, K as PackType } from "./index-CzjOXAKV.js";
...
import { a as useCallbackRef, P as Presence, b as Portal$1, c as composeEventHandlers, d as Primitive, e as createContextScope, h as hideOthers, f as dispatchDiscreteCustomEvent, g as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, i as createSlot, j as useControllableState, k as useId, u as ue, l as Dialog, m as DialogContent, n as DialogHeader, o as DialogTitle } from "./dialog-CJ93aDV1.js";
import { u as useDirection, c as createCollection } from "./index-DLRQxUD4.js";
import { R as Root2$1, A as Anchor, c as createPopperScope, C as Content, a as Arrow } from "./index-DNeazPiK.js";
import { I as Item, c as createRovingFocusGroupScope, R as Root, P as Pen } from "./index-DtStPA_i.js";
import { I as Input } from "./input-BEbbIodm.js";
import { L as Label$1 } from "./label-8vErBWyE.js";
...
import { S as ScanLine, C as Camera } from "./scan-line-Cie3aqbI.js";
/**
...
const Barcode = createLucideIcon("barcode", __iconNode$3);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit && editProduct) {
        ...
        const input = {
          shopId: (shopConfig == null ? void 0 : shopConfig.shopName) ?? "",
          name: productName,
          category: form.category,
          unit: form.unit,
          retailPrice: Number(form.retailPrice) || 0,
...
function ProductsPage() {
  ...
  const loadProducts = reactExports.useCallback(async () => {
    ...
    try {
      const [data, supplierList] = await Promise.all([
        ...
        api.listSuppliersByShop((shopConfig == null ? void 0 : shopConfig.shopName) ?? "")
      ]);
      if (!cancelled) {
        setProducts(data);
  ...
  }, [api, shopConfig == null ? void 0 : shopConfig.shopName]);
  reactExports.useEffect(() => {
    void loadProducts();
  }, [loadProducts]);
